...
describe('Evaluator', () => {
    ...
    it('compareTraces detects latency regression', () => {
        const fast = [{ ...makeSpan(), operation: 'llm.call', startTime: 0, endTime: 10, attributes: { totalTokens: 50 } }];
        const slow = [{ ...makeSpan(), operation: 'llm.call', startTime: 0, endTime: 10000, attributes: { totalTokens: 100000 } }];
    ...
    it('compareTraces detects reliability regression', () => {
        ...
        const bad = [makeSpan(), { ...makeSpan(), status: 'error' }];
