...
9. **认知差距诊断**：当AI话题出现分歧时，先问「双方用的是同一代模型吗」——免费tier用户和最新SOTA用户的体验完全不同
10. **编译优于检索**：个人知识管理中，先用LLM「编译」原始素材为结构化知识，而非在查询时实时检索原始文本
...
| 2026-03 | "AI Psychosis"论述 | 开发者已中AI之毒，普通人即将跟上 |
| 2026-04 | "Growing Gap"论断：AI能力认知分裂 | 免费用户vs付费用户对AI的认知差距在扩大 |
| 2026-04 | 个人知识库架构（Compiler类比） | LLM知识管理新范式：编译>检索 |
...
5. **调研截止时间**：2026年4月12日。此后的内容（Eureka Labs进展、新博文、新立场）未收录。
6. **"AI Psychosis"概念**：2026年3月提出，指开发者已深度依赖AI到「脱离现实」的程度。这是他最新的观察框架，尚未经过充分验证。
