...
exports.AdvancedAgent = void 0;
const agent_1 = require("./agent");
class AdvancedAgent extends agent_1.Agent {
    constructor(config) {
        super(config);
        this.interactionHistory = new Map();
        this.grimTriggered = new Set(); // 被 Grim Trigger 标记的 agents
        this.lastMove = new Map(); // 上一次的决策（用于 Pavlov）
     ...
     */
    shouldCooperateWith(otherAgent) {
     ...
     * 记录交互历史
     */
    recordStrategicInteraction(partnerId, partnerCooperated) {
     ...
     * 获取与特定 agent 的交互历史
     */
    getInteractionHistory(partnerId) {
...
exports.AdvancedAgent = AdvancedAgent;
