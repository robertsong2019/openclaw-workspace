...
const advanced_agent_1 = require("./src/advanced-agent");
let passed = 0;
let failed = 0;
...
test('Tit-for-Tat: Initial cooperation', () => {
    const agent1 = new advanced_agent_1.AdvancedAgent({
        id: 'tft-1',
        name: 'TFT Agent',
    ...
    const agent2 = new agent_1.Agent({ id: 'partner', name: 'Partner', behavior: 'neutral' });
    return agent1.shouldCooperateWith(agent2) === true;
});
test('Tit-for-Tat: Cooperates after partner cooperates', () => {
    const tft = new advanced_agent_1.AdvancedAgent({
        id: 'tft-2',
        name: 'TFT',
        behavior: 'cooperative',
        strategy: 'tit-for-tat'
    });
    const partner = new agent_1.Agent({ id: 'partner-2', name: 'Partner', behavior: 'cooperative' });
    // 记录对方合作
...
test('Tit-for-Tat: Defects after partner defects', () => {
    ...
    const partner = new agent_1.Agent({ id: 'partner-3', name: 'Partner', behavior: 'adversarial' });
    // 记录对方背叛
...
test('Tit-for-Tat: Forgives after partner returns to cooperation', () => {
    ...
    const partner = new agent_1.Agent({ id: 'partner-4', name: 'Partner', behavior: 'neutral' });
    // 背叛 -> 合作
...
test('Grim Trigger: Initial cooperation', () => {
    const grim = new advanced_agent_1.AdvancedAgent({
        id: 'grim-1',
        name: 'Grim',
        behavior: 'cooperative',
        strategy: 'grim-trigger'
    });
    const partner = new agent_1.Agent({ id: 'partner-5', name: 'Partner', behavior: 'neutral' });
...
test('Grim Trigger: Never forgives after defection', () => {
    ...
    const partner = new agent_1.Agent({ id: 'partner-6', name: 'Partner', behavior: 'neutral' });
    // 对方背叛
...
test('Grim Trigger: Cooperates with different partners independently', () => {
    ...
    const partner1 = new agent_1.Agent({ id: 'partner-7', name: 'Partner 1', behavior: 'neutral' });
    const partner2 = new agent_1.Agent({ id: 'partner-8', name: 'Partner 2', behavior: 'neutral' });
    // Partner 1 背叛
...
test('Pavlov: Initial cooperation', () => {
    const pavlov = new advanced_agent_1.AdvancedAgent({
        id: 'pavlov-1',
        name: 'Pavlov',
        behavior: 'cooperative',
        strategy: 'pavlov',
    ...
    const partner = new agent_1.Agent({ id: 'partner-9', name: 'Partner', behavior: 'neutral' });
...
test('Pavlov: Keeps strategy when both cooperate', () => {
    ...
    const partner = new agent_1.Agent({ id: 'partner-10', name: 'Partner', behavior: 'cooperative' });
    // 双方合作（赢了）
...
test('Pavlov: Changes strategy when exploited', () => {
    ...
    const partner = new agent_1.Agent({ id: 'partner-11', name: 'Partner', behavior: 'adversarial' });
    // 我合作，对方背叛（输了）
...
test('Random: Returns boolean', () => {
    const random = new advanced_agent_1.AdvancedAgent({
        id: 'random-1',
        name: 'Random',
        behavior: 'neutral',
        strategy: 'random'
    });
    const partner = new agent_1.Agent({ id: 'partner-12', name: 'Partner', behavior: 'neutral' });
...
test('Random: Shows variation over multiple calls', () => {
    ...
    const partner = new agent_1.Agent({ id: 'partner-13', name: 'Partner', behavior: 'neutral' });
...
test('Adaptive: Cooperates with high cooperation rate', () => {
    const adaptive = new advanced_agent_1.AdvancedAgent({
        id: 'adaptive-1',
        name: 'Adaptive',
        behavior: 'neutral',
        strategy: 'adaptive'
    });
    const partner = new agent_1.Agent({ id: 'partner-14', name: 'Partner', behavior: 'cooperative' });
    // 对方多次合作
    for (let i = 0; i < 10; i++) {
...
test('Adaptive: Defects against low cooperation rate', () => {
    ...
    const partner = new agent_1.Agent({ id: 'partner-15', name: 'Partner', behavior: 'adversarial' });
    // 对方多次背叛
    for (let i = 0; i < 10; i++) {
...
test('Adaptive: Uses trust score in uncertain cases', () => {
    ...
    const highTrustPartner = new agent_1.Agent({
        id: 'partner-16',
        name: 'High Trust',
        behavior: 'cooperative',
        initialTrust: 0.8
...
test('Reset strategy clears history', () => {
    ...
    const partner = new agent_1.Agent({ id: 'partner-reset', name: 'Partner', behavior: 'neutral' });
    // 背叛并触发
...
test('AdvancedAgent extends Agent correctly', () => {
    const advanced = new advanced_agent_1.AdvancedAgent({
        id: 'extend-test',
        name: 'Advanced',
        behavior: 'cooperative',
        strategy: 'tit-for-tat'
