...
const visualizer_1 = require("./src/visualizer");
console.log('╔════════════════════════════════════════════════════════════╗');
...
const agents = [
    // 合作型 Agent（高可靠性）
    { id: 'agent-1', name: 'Alice', behavior: 'cooperative', reliability: 0.95 },
    { id: 'agent-2', name: 'Bob', behavior: 'cooperative', reliability: 0.90 },
    { id: 'agent-3', name: 'Charlie', behavior: 'cooperative', reliability: 0.85 },
    // 中立型 Agent
    { id: 'agent-4', name: 'David', behavior: 'neutral', reliability: 0.75 },
    { id: 'agent-5', name: 'Eve', behavior: 'neutral', reliability: 0.70 },
    // 恶意 Agent
    { id: 'agent-6', name: 'Mallory', behavior: 'malicious', reliability: 0.40 },
    { id: 'agent-7', name: 'Trudy', behavior: 'malicious', reliability: 0.35 },
    // 对抗型 Agent（故意破坏）
    { id: 'agent-8', name: 'Adversary', behavior: 'adversarial', reliability: 0.10 }
];
...
// 显示初始状态
console.log(visualizer_1.Visualizer.renderNetworkGraph(network));
// 模拟一系列交互
...
console.log(visualizer_1.Visualizer.renderNetworkGraph(network));
// 显示交互历史
console.log(visualizer_1.Visualizer.renderInteractionHistory(interactionHistory));
// 应用信任衰减
...
console.log(visualizer_1.Visualizer.renderNetworkGraph(network));
// 演示信任传播
console.log(visualizer_1.Visualizer.renderTrustPropagation(network, 5));
// 导出网络状态
