...
const trust_metrics_1 = require("./src/trust-metrics");
let passed = 0;
let failed = 0;
...
test('TrustMetrics: Creates instance with default history size', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    return metrics instanceof trust_metrics_1.TrustMetrics;
});
test('TrustMetrics: Records snapshot for agent', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'test-1', name: 'Test', behavior: 'cooperative' });
...
test('TrustMetrics: Limits history size', () => {
    const metrics = new trust_metrics_1.TrustMetrics(5);
    const agent = new agent_1.Agent({ id: 'test-2', name: 'Test', behavior: 'cooperative' });
    // Record 10 snapshots
    for (let i = 0; i < 10; i++) {
        agent.recordInteraction(true);
        metrics.recordSnapshot(agent);
...
test('Trust Velocity: Returns 0 for single snapshot', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'vel-1', name: 'Test', behavior: 'cooperative' });
    metrics.recordSnapshot(agent);
...
test('Trust Velocity: Detects rising trend', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'vel-2', name: 'Test', behavior: 'cooperative' });
...
test('Trust Velocity: Detects falling trend', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'vel-3', name: 'Test', behavior: 'cooperative' });
...
test('Trust Velocity: Detects stable trend', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'vel-4', name: 'Test', behavior: 'cooperative' });
...
test('Trust Volatility: Returns 0 for single snapshot', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'vol-1', name: 'Test', behavior: 'cooperative' });
    metrics.recordSnapshot(agent);
    const agentMetrics = metrics.calculateAgentMetrics(agent);
...
test('Trust Volatility: Low volatility for stable agent', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'vol-2', name: 'Test', behavior: 'cooperative' });
    // Consistent behavior
    for (let i = 0; i < 20; i++) {
        agent.recordInteraction(true);
        metrics.recordSnapshot(agent);
...
test('Trust Volatility: High volatility for unstable agent', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'vol-3', name: 'Test', behavior: 'neutral' });
...
test('Reputation Score: In range [0, 1]', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'rep-1', name: 'Test', behavior: 'cooperative' });
    for (let i = 0; i < 10; i++) {
        agent.recordInteraction(true);
        metrics.recordSnapshot(agent);
    }
...
test('Reputation Score: Higher for cooperative agent', () => {
    const metrics1 = new trust_metrics_1.TrustMetrics();
    const metrics2 = new trust_metrics_1.TrustMetrics();
    const coopAgent = new agent_1.Agent({ id: 'coop', name: 'Cooperative', behavior: 'cooperative' });
    const advAgent = new agent_1.Agent({ id: 'adv', name: 'Adversarial', behavior: 'adversarial' });
    for (let i = 0; i < 20; i++) {
...
test('Reputation Score: Increases with experience', () => {
    const metrics1 = new trust_metrics_1.TrustMetrics();
    const metrics2 = new trust_metrics_1.TrustMetrics();
    const newAgent = new agent_1.Agent({ id: 'new', name: 'New', behavior: 'cooperative' });
    const expAgent = new agent_1.Agent({ id: 'exp', name: 'Experienced', behavior: 'cooperative' });
...
test('Confidence Level: Low for new agent', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'conf-1', name: 'New', behavior: 'cooperative' });
    agent.recordInteraction(true);
    metrics.recordSnapshot(agent);
    const agentMetrics = metrics.calculateAgentMetrics(agent);
...
test('Confidence Level: High for experienced stable agent', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'conf-2', name: 'Experienced', behavior: 'cooperative' });
...
test('Confidence Level: Reduced by volatility', () => {
    const metrics1 = new trust_metrics_1.TrustMetrics();
    const metrics2 = new trust_metrics_1.TrustMetrics();
    const stableAgent = new agent_1.Agent({ id: 'stable', name: 'Stable', behavior: 'cooperative' });
    const volatileAgent = new agent_1.Agent({ id: 'volatile', name: 'Volatile', behavior: 'neutral' });
...
test('Reliability: High for high confidence + low volatility', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'rel-1', name: 'Reliable', behavior: 'cooperative' });
    for (let i = 0; i < 50; i++) {
        agent.recordInteraction(true);
        metrics.recordSnapshot(agent);
    }
...
test('Reliability: Low for low confidence or high volatility', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'rel-2', name: 'Unreliable', behavior: 'neutral' });
...
test('Network Metrics: Calculates average trust', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agents = [
        new agent_1.Agent({ id: 'n1', name: 'A1', behavior: 'cooperative' }),
        new agent_1.Agent({ id: 'n2', name: 'A2', behavior: 'cooperative' })
    ];
...
test('Network Metrics: Calculates trust distribution', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agents = [
        new agent_1.Agent({ id: 'd1', name: 'High', behavior: 'cooperative' }),
        new agent_1.Agent({ id: 'd2', name: 'Medium', behavior: 'neutral' }),
        new agent_1.Agent({ id: 'd3', name: 'Low', behavior: 'adversarial' })
    ];
    // High trust
    for (let i = 0; i < 20; i++)
        agents[0].recordInteraction(true);
    ...
    // Low trust
    for (let i = 0; i < 20; i++)
        agents[2].recordInteraction(false);
    agents.forEach(a => metrics.recordSnapshot(a));
    const networkMetrics = metrics.calculateNetworkMetrics(agents);
...
test('Export/Import: Preserves history', () => {
    const metrics1 = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'export-1', name: 'Test', behavior: 'cooperative' });
    for (let i = 0; i < 5; i++) {
        agent.recordInteraction(true);
...
test('Clear History: Removes all data', () => {
    const metrics = new trust_metrics_1.TrustMetrics();
    const agent = new agent_1.Agent({ id: 'clear-1', name: 'Test', behavior: 'cooperative' });
    for (let i = 0; i < 5; i++) {
        agent.recordInteraction(true);
        metrics.recordSnapshot(agent);
    }
